# Decision 74 — METAUSDT — no_trade

**Decided** 2026-09-13T01:22:03.015248+00:00 during the weekend session, 36.13h from the next price discovery.
**Size** 0 BUY at 649.86; entry cost 0.000bps.
**Stated confidence** 0.92

## Why
Weekend session with 36 hours to genuine price discovery, no material catalyst, no hedge menu available, and consensus neutral at 0.89. The -40.8% QoQ earnings decline lacks context (no consensus estimates, no guidance) to determine if it's a surprise or already priced in. No edge exceeds the 18.80 bps hurdle.

## What would make this wrong
- A material catalyst emerges before Monday open that would move the token significantly
- New information reveals the Q2 earnings decline was unexpected relative to consensus
...
- panel: 3 analysts, 10 distinct sources, independence 3.33 -> neutral at 0.89 after provenance discount
...
- [claim] 1 checkable claim(s) agree with the 10 structured record(s) behind them
...
## Integrity
market state `06649bd521237492`, approved intent `b84f791424195166`, chained to `63ea953e9d65df0b`.
