# Decision 80 — QQQUSDT — no_trade

**Decided** 2026-09-13T01:22:03.015248+00:00 during the weekend session, 36.13h from the next price discovery.
**Size** 0 BUY at 714.61; entry cost 0.000bps.
**Stated confidence** 0.92

## Why
Weekend session with 36+ hours until genuine price discovery, no hedge menu available, zero directional edge from evidence, and a total hurdle of 18.80 bps that no identified catalyst can clear. The SpaceX Nasdaq 100 weighting story is structural and already priced.

## What would make this wrong
- A material macro or geopolitical event occurs before Monday open that shifts QQQ fair value by more than 19 bps in a direction identifiable from available data
- The token price gaps significantly from the last anchor close when markets reopen, indicating the weekend thesis was wrong

## What the checkers found
2 finding(s):
- [grounding] 1 of 3 figure(s) do not resolve to anything the desk was given: 0.89
...
- panel: 2 analysts, 3 distinct sources, independence 1.50 -> neutral at 0.89 after provenance discount
...
## Integrity
market state `30746dbb08b830d5`, approved intent `c0bd121c522ca20e`, chained to `33823a4ca7721e13`.
