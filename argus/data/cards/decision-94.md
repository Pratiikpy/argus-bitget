# Decision 94 — COINUSDT — no_trade

**Decided** 2026-09-13T03:22:02.799291+00:00 during the weekend session, 34.13h from the next price discovery.
**Size** 0 BUY at 175.42; entry cost 0.000bps.
**Stated confidence** 0.82

## Why
Weekend session with 34+ hours until price discovery, bearish earnings panel (16/16 downward revisions, revenue declining QoQ, net losses), MACD death cross, and no hedge available — the evidence is adequate and points to no actionable edge exceeding the 18.8 bps hurdle.

## What would make this wrong
- Consensus EPS revisions flip net positive (up > down) before next session
- Price gaps above MA99 (~181.28) on genuine volume at Monday open indicating a catalyst not yet priced
- A material positive regulatory or business catalyst (e.g., Clarity Act passage with favorable terms) confirmed before anchor market opens
...
- [skills] 6 of 6 official-Skill calls answered for COINUSDT; 1 of 5 Skills reached (technical-analysis)
...
## Integrity
market state `f226db25be721632`, approved intent `23b39ffb2c5cba2d`, chained to `cb5f1dd35df97950`.
