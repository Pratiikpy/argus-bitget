# Decision 78 — COINUSDT — no_trade

**Decided** 2026-09-13T01:22:03.015248+00:00 during the weekend session, 36.13h from the next price discovery.
**Size** 0 BUY at 175.74; entry cost 0.000bps.
**Stated confidence** 0.78

## Why
Weekend session with 36+ hours to genuine price discovery, no hedge available, bearish earnings panel (revenue -13.7% QoQ, net income -$360M), and no actionable catalyst that clears the 18.80 bps hurdle justify standing aside.

## What would make this wrong
- If a material positive catalyst (e.g., regulatory approval, major partnership, or earnings beat guidance) emerges before Monday open with sufficient liquidity to act on it
- If COIN price gaps significantly lower on Sunday open creating a mean-reversion opportunity exceeding the 18.80 bps hurdle
...
- panel: 2 analysts, 6 distinct sources, independence 3.00 -> bearish at 0.62 after provenance discount
...
## Integrity
market state `5f4bb82bd855f168`, approved intent `5bc0bbbecdd26aa3`, chained to `3d1b9aef6b8b29b6`.
