# Decision 100 — METAUSDT — no_trade

**Decided** 2026-09-13T05:22:03.626841+00:00 during the weekend session, 32.13h from the next price discovery.
**Size** 0 BUY at 648.54; entry cost 0.000bps.
**Stated confidence** 0.82

## Why
Weekend session with 32+ hours until genuine price discovery, no hedge available, conflicting technical signals, and a bearish earnings panel (QoQ net income -41%, heavy downward consensus revisions) provide no actionable edge exceeding the 18.80 bps hurdle.

## What would make this wrong
- Price gaps up more than 2% at Monday open on a novel fundamental catalyst not yet in evidence
- Consensus EPS revisions reverse sharply positive before next session
...
- [skills] 6 of 6 official-Skill calls answered for METAUSDT; 1 of 5 Skills reached (technical-analysis); 1 of 5 reachable
...
## Integrity
market state `b8713a0eb02dea5b`, approved intent `8767de3943da1802`, chained to `e35e7587c4f5c0af`.
