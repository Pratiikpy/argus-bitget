# Decision 65 — TSLAUSDT — no_trade

**Decided** 2026-09-12T18:13:31.953607+00:00 during the weekend session, 43.27h from the next price discovery.
**Size** 0 BUY at 366.23; entry cost 0.000bps.
**Stated confidence** 0.92

## Why
Weekend session with 43+ hours to genuine price discovery, flat 24h price action (+0.24%), contradictory news mix, and no hedge available. No edge exceeds the 18.80 bps total hurdle.

## What would make this wrong
- A material catalyst (e.g., regulatory action, major delivery revision, or structural market event) emerges before Monday open that would reprice the token significantly away from 366.23

## What the checkers found
2 finding(s):
- [grounding] 1 of 3 figure(s) do not resolve to anything the desk was given: +0.24%
...
- panel: 2 analysts, 4 distinct sources, independence 2.00 -> neutral at 0.86 after provenance discount
...
## Integrity
market state `19a7e067848eb4d2`, approved intent `37a8259e8bfeec83`, chained to `bad76145000d7769`.
