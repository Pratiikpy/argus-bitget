...
```
6,420 tests collected   ruff clean   mypy --strict clean on 307 source files
...
- **The `side` field carries no information, and that was measured rather than assumed.** Over the
  ...
  (`eval/shadow.py`). **460 decisions carry a lean** so far — already UP and DOWN at differing
