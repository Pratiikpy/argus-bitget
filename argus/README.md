...
```
6,700 tests collected   ruff clean   mypy --strict clean on 457 source files
...
- **7 of 43 capabilities are OWNED; one more reaches twelve of thirteen and stops there for a
