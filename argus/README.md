...
```
6,700 tests collected   ruff clean   mypy --strict clean on 473 source files
...
- **8 of 43 capabilities are OWNED; one more reaches twelve of thirteen and stops there for a
