...
```
6,700 tests collected   ruff clean   mypy --strict clean on 317 source files
142/142 modules importable           18/18 sub-themes resolve to a symbol and a test file
...
- **20 of 34 capabilities are OWNED; one more reaches twelve of thirteen and stops there for a
