...
```
6,700 tests collected   ruff clean   mypy --strict clean on 341 source files
...
- **20 of 42 capabilities are OWNED; one more reaches twelve of thirteen and stops there for a
