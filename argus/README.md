...
- Every decision is hash-chained **before** its outcome exists, and **236 claims across the
...
627 decisions were taken in a tradeable session with the anchor market open, and **344 of them
...
```
6,682 tests collected   ruff clean   mypy --strict clean on 315 source files
140/140 modules importable           18/18 sub-themes resolve to a symbol and a test file
...
python -m argus.research.cointegration     # which rToken pairs are actually cointegrated (66 tests, corrected; ~2 min)
...
- **Zero positions have settled.** All 627 ledger entries are refusals, and 481 have settled as
...
- **20 of 33 capabilities are OWNED; one more reaches twelve of thirteen and stops there for a
