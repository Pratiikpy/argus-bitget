# ARGUS's own `argus/desk/rotation.py` exactly as it stood before the 2026-09-25 data contract,
# kept verbatim below the "PRE-CONTRACT SOURCE FROM HERE" marker as the ablation baseline for
# `argus.eval.general_rotation_comparison`: the same corpus is run through this file and through
# the current `argus.desk.rotation`, so what the contract clauses changed is measured, not recalled.
#
# SHA-256 of the original file (every byte below the marker line, including the trailing newline):
#   c22e86ab614ae4b417611b7442b3375bb861ebe37dc012d8866c63bfcb3e8fba
# Pinned by `tests/test_general_rotation_comparison.py::TestAblationBaselinePinned`.
#
# Nothing imports this file except that comparison. Its CLI is never run.
# ============================== PRE-CONTRACT SOURCE FROM HERE ==============================
