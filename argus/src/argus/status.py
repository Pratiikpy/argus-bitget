...
MODULES = (
    ...
    "argus.eval.copilot_rivals", "argus.eval.copilot_stress", "argus.eval.copilot_hedge",
    "argus.eval.baselines.skfolio_stress", "argus.market.rtoken_spot", "argus.desk.rtoken_hedge",
    "argus.market.ws_tape", "argus.eval.execution_arena", "argus.lui.design",
    "argus.lui.brand_page",
