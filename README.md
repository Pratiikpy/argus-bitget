...
pytest -q                       # 6,692 tests collected
```
...
| | |
|---|---|
| Tests | **6,692 tests collected** — run `pytest -q` |
| Type checking | **`mypy --strict` clean on 316 source files** |
| Lint | `ruff` clean |
| Module health | **141/141 modules importable**, checked by `python -m argus.status` |
