...
| Type checking | **`mypy --strict` clean on 317 source files** |
| Lint | `ruff` clean |
| Module health | **142/142 modules importable**, checked by `python -m argus.status` |
